...
var authConfig = __importStar(require("../configs/auth"));
var jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
var bcryptjs_1 = __importDefault(require("bcryptjs"));
var compare = bcryptjs_1["default"].compare;
...
var SessionsController = /** @class */ (function () {
    ...
    SessionsController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, username, password, user, passwordMatched, _b, secret, expiresIn, token;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        user = _c.sent();
                        if (!user) {
                            throw new Error_1.Error("Username e/ou senha incorreta!", 401);
                        }
                    ...
                    case 2:
                        ...
                        _b = authConfig.jwt, secret = _b.secret, expiresIn = _b.expiresIn;
                        token = sign({}, secret, {
